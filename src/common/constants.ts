...
export const GALA_CAP = BigInt.fromString('5000000000000000000')
export const TOWN_CAP = BigInt.fromString('100000000000000000000000')
export const SILK_CAP = BigInt.fromString('10000000000000000')
